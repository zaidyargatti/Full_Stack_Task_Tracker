...
import { Create_Task, Delete_Task, Get_Task_By_Project, Toggle_Task, Update_Task } from '../controllers/task.controller.js'
...
way.put('/update-task/:id',protect,Update_Task)
